	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="/AutobuskaStanicaWEB/RegistrationSERVLET" method="get">SIGNUP</a></li>
    ...
    <div class="item active">
      ...
      <div class="container">
        <div class="caraous-title">
            <div class="col-md-12">
                <div class="col-md-6">
                    <span>Non-Profit BUS Organization</span>
                    <h3>We are non-profit BUS Organization</h3>
                    <form action="/AutobuskaStanicaWEB/RedVoznjeSERVLET" method="get">
			<button type="submit" class="btn btn-lg btn-info">RED VOZNJE</button>
		</form>
                </div>
