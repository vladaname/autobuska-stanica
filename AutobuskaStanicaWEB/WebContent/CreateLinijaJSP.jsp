...
<body>
	...
	<div class="wrapper fadeInDown">
		<div id="formContent">
			...
			<!-- Login Form -->
			<form action="/AutobuskaStanicaWEB/CreateLinijaSERVLET" method="post">
				<input type="text" id="name" name="nazivLinije"
					placeholder="nazivLinije"> <input type="text" id="surname"
					name="opisLinije" placeholder="opisLinije"> <input
