	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="/AutobuskaStanicaWEB/Login" method="get">LOGIN</a></li>
				<li><a href="/AutobuskaStanicaWEB/Registracija" method="get">SIGNUP</a></li>
	...
	<div class="wrapper fadeInDown">
		<div id="formContent">
			...
			<div class="fadeIn first">
				<h1>AutobuskaStanicaWEB</h1>
				<h3>Login</h3>
			</div>

			<!-- Login Form -->
			<form action="/AutobuskaStanicaWEB/LoginSERVLET" method="post">
